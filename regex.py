...
class Regex():
    ...
    def __init__(self)->None:
        ...
        try:
            ...
            self._sentence_pattern = re.compile("^[A-Z]+[a-z\s]+\.$")
            self._matching_string=self._sentence_pattern.search("Come and get your pencil.")[0]
    ...
    def search_partsOfSpeech(self) ->str:
        """
        This method gets the tokens and classify them through parts of speech using my dictionary file

        Attributes
        ----------
        content: a line in my dictionary file 
